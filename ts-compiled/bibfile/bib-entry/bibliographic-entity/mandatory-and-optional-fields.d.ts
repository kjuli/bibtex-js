...
export declare function hasOptionalFields(s: string): s is Extract<(keyof typeof optionalFields), string>;
export declare function hasMandatoryFields(s: string): s is Extract<(keyof typeof mandatoryFields), string>;
...
export declare const findError: (entry: BibEntry, field: MandatoryFields) => (Error | undefined);
